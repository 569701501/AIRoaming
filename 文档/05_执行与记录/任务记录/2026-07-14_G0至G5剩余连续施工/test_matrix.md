...
| G4-GATE-06 | favorite/reject | 不改变 lock set/layout/export freshness | `not_run` |
...
| G4-GATE-12 | legacy authority scan | runtime 无 selected/locked/旧 lock API 权威路径 | `not_run` |
