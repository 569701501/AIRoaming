...
`A2_ready`。M4 已正式通过；M5-A0 capability registry 与 M5-A1 coordinated backup 已实现并单独验收，接下来可在临时 data/workspace/SQLite 根开发 M5-A2。M6、final import 和真实 production activate 继续阻塞。
