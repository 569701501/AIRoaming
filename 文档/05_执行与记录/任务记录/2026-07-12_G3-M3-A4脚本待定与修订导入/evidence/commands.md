---
doc_id: AIR-G3-M3-A4-EVIDENCE-001
status: active
created: 2026-07-12
updated: 2026-07-12
owner: AI漫游项目
...
| `pnpm --filter @airoaming/server exec vitest run src/migration/project-chapter-shadow-importer.integration.spec.ts -t IMP-A4-01 --maxWorkers 1 --minWorkers 1` | passed |
| `pnpm --filter @airoaming/server exec vitest run --maxWorkers 1 --minWorkers 1` | 44 files / 241 tests passed |
