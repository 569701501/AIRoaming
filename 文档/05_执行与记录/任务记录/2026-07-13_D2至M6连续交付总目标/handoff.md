...
| final importer | 已实现并由 FIN-01～10、D2-WIT 复核 |
| `db:activate` | 已实现；真实 execute 仍需单独授权 |
| M6 | `m6_tooling_passed`；临时根演练完成 |
...
- [x] M6 C0～C7 在全隔离 fixture 中顺序演练通过；故障/回滚边界保持 fail-closed，真实 RB/切换仍需授权。
