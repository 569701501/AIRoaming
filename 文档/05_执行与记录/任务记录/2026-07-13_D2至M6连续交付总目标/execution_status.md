...
| P4 D2-A3-2A | in_progress | `e80b8ee`, `f2b4d15`, `71c3a3a`, `0987050`, `a8486a6`, `03eea76`, pending | 30 targeted + 54 files/371 tests | 371/371 | PASS | PASS | scene queue/source projection now done; Character delete and CandidateLock remain |
| P5 D2-A3-2B | pending | - | - | - | - | - | - |
| P6 D2-A4 | pending | - | - | - | - | - | - |
| P7 D2-A5 | pending | - | - | - | - | - | - |
| P8 D2-A6 | pending | - | - | - | - | - | - |
