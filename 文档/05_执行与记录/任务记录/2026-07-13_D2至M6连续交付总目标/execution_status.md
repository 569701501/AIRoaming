...
| P1 D2-A2-1 | passed | pending commit | 27 targeted + 54 files/360 tests | 360/360 | PASS | PASS | A2-2 clear/import/reset remains blocked; next phase only after commit |
| P2 D2-A2-2 | in_progress | - | - | - | - | - | started after P1 review |
| P2 D2-A2-2 | pending | - | - | - | - | - | - |
| P3 D2-A3-1 | pending | - | - | - | - | - | - |
| P4 D2-A3-2A | pending | - | - | - | - | - | - |
| P5 D2-A3-2B | pending | - | - | - | - | - | - |
