...
| P5 D2-A3-2B | in_progress | `9b097ed`, `30131b5`, `5ad342f`, `cbf89e0` | 31 targeted + 54 files/372 tests | 372/372 | PASS | PASS | CandidateLock/images_done done; legacy generate/ensure retired; Character delete remains |
| P6 D2-A4 | pending | - | - | - | - | - | - |
| P7 D2-A5 | pending | - | - | - | - | - | - |
| P8 D2-A6 | pending | - | - | - | - | - | - |
| P9 D2-A7 | pending | - | - | - | - | - | - |
