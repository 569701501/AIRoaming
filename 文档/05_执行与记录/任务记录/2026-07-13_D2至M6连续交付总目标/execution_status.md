...
| P4 D2-A3-2A | in_progress | `e80b8ee`, `f2b4d15`, queue commit pending | 24 targeted + 54 files/365 tests | 365/365 | PASS | PASS | identity/extract + reference task queue done; worker/staged Asset/Visual remain |
| P5 D2-A3-2B | pending | - | - | - | - | - | - |
| P6 D2-A4 | pending | - | - | - | - | - | - |
| P7 D2-A5 | pending | - | - | - | - | - | - |
| P8 D2-A6 | pending | - | - | - | - | - | - |
