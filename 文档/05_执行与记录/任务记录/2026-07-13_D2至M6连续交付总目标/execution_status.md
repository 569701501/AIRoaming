...
| P4 D2-A3-2A | in_progress | `e80b8ee`, `f2b4d15`, `71c3a3a`, `0987050`, `a8486a6`, `03eea76` | 29 targeted + 54 files/370 tests | 370/370 | PASS | PASS | character worker/confirm + SceneVisual worker done; public scene queue/delete/CandidateLock remain |
| P5 D2-A3-2B | pending | - | - | - | - | - | - |
| P6 D2-A4 | pending | - | - | - | - | - | - |
| P7 D2-A5 | pending | - | - | - | - | - | - |
| P8 D2-A6 | pending | - | - | - | - | - | - |
