...
- A3-2A 正在收口 Character/Asset：identity、queue/source freeze、worker staged→ready/CharacterVisual、preview/final confirm 已完成；aggregate 仍 partial，下一步继续 delete/SceneVisual。
