...
- A3-2A 正在收口 Character/Asset：identity、queue/source freeze、Character worker/Visual confirm、SceneVisual worker 已完成；公开 scene queue/source projection、delete、CandidateLock 仍未完成。
