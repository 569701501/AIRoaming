...
3. AI 创作 P1/P2/P3/P5 已使用“Prompt 内部自检 + Server 高置信固定触发 + 一次定向重写”落地；不新增灵感、大纲、章节或页面字段。更细的新鲜度、情绪力度、场景艺术判断和完整世界状态连续性继续由模型与用户判断，不能用关键词规则冒充完整艺术评价。
4. P5 只对运行时真实提供的上一章当前正式全文负责：第 1 章跳过；第 N 章的前章正式版本、全文和摘要来源门禁保持不变；后一张章节卡不能被当成已经发生的事实。章节编辑链尚未注入完整前章事实，不在本次 P5 完成范围内。
5. AI 创作后续只做评测、提示词迭代和体验修正，不重新引入批量生成、自动切章或“继续下一章”。
