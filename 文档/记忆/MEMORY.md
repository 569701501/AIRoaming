...
- 2026-07-09 全功能竞品对照结论：AI漫游对比 Dashtoon、ComicAI、Anifusion、Midjourney/Niji、Leonardo、Firefly、Canva、Katalist、LTX、Runway、ComfyUI 后，优势是项目/章节流水线、剧情结构、正式分镜、preflight、候选锁定、素材包 manifest 和任务追溯；短板是 prompt 透明、单镜重画、批量生成、候选批次、局部 inpaint、气泡/分格排版、PDF/ZIP、发布分享和轻漫剧视频。新版 HTML 报告见 `文档/04_方案与决策/2026-07-09_全功能竞品对照报告.html`。
- 2026-07-09 项目提示词资产盘点：当前梳理到 27 个提示词/AI 指令资产，覆盖 Dialogue 动态提示词、OpenCode agent/skills、角色/场景/候选图生图提示词、工具描述和共享格式约束。后续提示词优化优先级：候选出图最终 provider prompt 与前端预览 prompt 统一、角色参考图提示词、分镜提示词。盘点 HTML 见 `文档/04_方案与决策/2026-07-09_项目提示词资产盘点.html`。
