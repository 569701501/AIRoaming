...
import { hasStaticVisualLocationTransition } from "../projects/candidate-visual-quality.util.js";
...
function assertStaticPanelQuality(
  ...
  if (hasStaticVisualLocationTransition({
    visualDescription: input.panelDescription,
    action: input.coreAction,
    composition: input.composition,
  })) {
    issues.push(`STORYBOARD_PANEL_MULTIPLE_LOCATIONS:${path}`);
  }
