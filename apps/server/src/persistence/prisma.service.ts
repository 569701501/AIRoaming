...
import { assertScriptWorkflowRuntimeMigrationReadyV1 } from "./script-workflow-runtime-migration-ledger.js";
...
export class PrismaService implements OnModuleInit, OnModuleDestroy {
  ...
  async onModuleInit(): Promise<void> {
    ...
    try {
      ...
      await assertScriptWorkflowRuntimeMigrationReadyV1(this.client);
    } catch (error) {
