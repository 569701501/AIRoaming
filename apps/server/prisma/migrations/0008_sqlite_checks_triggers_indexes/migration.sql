...
CREATE TABLE "chapters__g1_new" (
  ...
  CONSTRAINT "ck_chapters_working_consistency" CHECK ((script_working_state = 'empty' AND script_working_text = '') OR (script_working_state IN ('clean', 'dirty') AND length(script_working_text) > 0))
);
